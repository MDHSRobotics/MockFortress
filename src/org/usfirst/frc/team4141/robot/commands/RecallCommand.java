 ...
 * @see RopeSubsystem
 */
public class RecallCommand extends MDCommand {
	 ...
	 */
	public RecallCommand(MDRobotBase robot, String name) {
		super(robot, name);
	...
	protected void execute() {
		if (shootSubsystem!=null)shootSubsystem.recall();
		log(Level.DEBUG,"execute()","Recalling");
